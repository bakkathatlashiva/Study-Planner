...
export default function Sidebar({
  ...
  const isActive = (itemVal) => {
    if (
      itemVal === "career-screen" &&
      careerSubScreens.includes(currentScreen)
    ) {
      return true;
    }
        ...
        <div className="sidebar-top">
          <div className="sidebar-logo">
            ...
            >
              ...
              <path
                d="M52 25C38 25 28 35 28 47c0 5 2 10 6 13-4 2-6 6-6 10 0 8 7 14 16 14 3 0 6-1 8-3V25z"
                fill="#e8eaf6"
                stroke="#080e2b"
                strokeWidth="2"
              />
              <path
                d="M35 45Q40 42 45 46M33 57Q39 54 44 58M36 68Q41 65 46 69"
                stroke="#080e2b"
                strokeWidth="2"
                strokeLinecap="round"
                fill="none"
