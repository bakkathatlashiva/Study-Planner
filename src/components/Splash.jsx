  ...
  return (
    <div id="splash" className={`screen ${isActive ? 'active' : ''}`}>
      <svg className="splash-logo" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <line x1="52" y1="35" x2="62" y2="35" stroke="white" strokeWidth="2" />
        <line x1="62" y1="35" x2="68" y2="28" stroke="white" strokeWidth="2" />
        <circle cx="72" cy="26" r="4" fill="white" />
        <line x1="52" y1="47" x2="70" y2="47" stroke="white" strokeWidth="2" />
        <circle cx="75" cy="47" r="4" fill="white" />
        <line x1="52" y1="58" x2="62" y2="58" stroke="white" strokeWidth="2" />
        <line x1="62" y1="58" x2="70" y2="65" stroke="white" strokeWidth="2" />
        <circle cx="74" cy="67" r="4" fill="white" />
        <line x1="52" y1="72" x2="65" y2="72" stroke="white" strokeWidth="2" />
        <line x1="65" y1="72" x2="65" y2="80" stroke="white" strokeWidth="2" />
