...
app.post('/api/forgot-password', async (req, res) => {
  ...
  try {
    ...
    try {
      const fs = require('fs');
      fs.writeFileSync('C:/Users/bakka/.gemini/antigravity-ide/brain/d2577af7-1c5d-4c26-9fa4-158a614b5778/current_otp.txt', otp);
    } catch (e) {
    ...
    if (transporter) {
      const mailOptions = {
        from: process.env.SMTP_FROM || '"Study Planner Pro" <noreply@studyplanner.pro>',
        to: email,
